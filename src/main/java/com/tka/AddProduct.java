...
public class AddProduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/advjava193_product","root", "root");
			
			String query = "INSERT INTO advjava193_product.product(name,price,qty,category)VALUES(?,?,?,?) ";
